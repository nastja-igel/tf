...
## Token sync (Обнови токены)

When the user says **"Обнови токены"**:
1. Fetch all variables from Figma file `sVpDRrA1nRbENMMIcS3HqN` via Plugin API
2. Diff against current `src/tokens.figma.css`
